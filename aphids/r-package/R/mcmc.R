#' The work horse of the package
#' 
#' @param N The number of design points to attempt per m
#' @param m A vector (see paper)
#' @param no_of_cores Integer specifying the number of cores.
#' @param dir Directory to save the output file
#' @details Since a single aphid run takes less than a single, we actually generate
#' 4 * no_of_cores threads. This is a bit more efficient.
#' @importFrom beepr beep
#' @importFrom doParallel registerDoParallel
#' @export
mcmc = function(N, m, no_of_cores, dir=".") {
  no_d = 2
  doParallel::registerDoParallel(no_of_cores)
  no_of_threads = 4*no_of_cores
  message("Total evaluations: ", no_of_threads * N * (length(m)+1))
